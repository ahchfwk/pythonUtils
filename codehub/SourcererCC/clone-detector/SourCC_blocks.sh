...
Repository_Id=1
Release_Id=1
Detection_Granularity='Blocks'
Detection_Percent=0.80
...
RUN_DATE=`date`
START1=$(date +%s)
java -jar InputBuilderClassic.jar /mnt/winE/SourcererCC/clone-detector/input/dataset /mnt/winE/SourcererCC/clone-detector/input/query/tokens.file /mnt/winE/SourcererCC/clone-detector/input/bookkeping/headers.file blocks java 0 0 10 0 false false false 8
##程序第一部分运行结束时间
END1=$(date +%s)
##计算程序第一部分运行时间
